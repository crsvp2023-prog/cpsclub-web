  ...
  return (
    <div className="relative min-h-screen bg-white">
      <div className="relative z-10">
        ...
        {/* About Section */}
        <section className="py-3 px-6 bg-gradient-to-r from-[#0066FF] via-[#0052CC] to-[#003B82] border-t border-[var(--color-accent)]/30">
          <div className="mx-auto max-w-7xl">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              {/* Left Column - Text Content */}
              <div>
                <div className="inline-block mb-4 px-3 py-1 bg-white/20 rounded-full border border-white/30">
                  <p className="text-sm font-semibold text-white uppercase tracking-wide">Our Story</p>
                </div>
                ...
                <div className="mt-8 p-6 bg-white/10 rounded-lg text-white shadow-lg border border-white/20">
                  <p className="text-xs font-bold text-white/70 uppercase tracking-widest mb-2">Our Motto</p>
                  <h3 className="text-4xl font-black mb-3" style={{ color: '#FFD100' }}>One Team,<br />One Dream</h3>
                  <p className="text-sm text-white/90 font-medium">Unity. Excellence. Community.</p>
                </div>
              </div>

              {/* Right Column - Fan Fest Section */}
              <div>
                <div className="inline-block px-3 py-1 bg-[var(--color-accent)]/20 rounded-full mb-4 border border-[var(--color-accent)]/40">
                  <p className="text-sm font-semibold text-white uppercase tracking-wider">⭐ Featured Highlight</p>
                </div>
                
                <h3 className="text-4xl font-bold text-white mb-1">
                  Fan Fest <span className="text-[var(--color-accent)]">2024</span>
                </h3>
                <p className="text-2xl font-bold text-[var(--color-accent)] mb-6">with Brett Lee</p>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <a
                    href="/gallery"
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[var(--color-accent)] text-[var(--color-dark)] rounded-lg font-bold text-sm hover:shadow-lg hover:scale-105 transition-all duration-300 uppercase tracking-wider"
                  >
                    View Gallery →
                  </a>
                  <a
                    href="/about"
                    className="inline-flex items-center justify-center gap-2 px-6 py-3 border border-white/30 text-white rounded-lg font-semibold text-sm hover:bg-white/10 transition-all duration-300"
                  >
                    Learn More
                  </a>
                </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-2 gap-8 items-stretch">
              <div className="space-y-4 flex flex-col h-full">
                <h2 className="text-2xl font-bold text-gray-900">Next Match</h2>
                <div className="flex-1">
                  <MatchCountdown />
                </div>
              </div>
              <div className="space-y-4 flex flex-col h-full">
                <h2 className="text-2xl font-bold text-gray-900">Make Your Prediction</h2>
                <div className="flex-1">
                  <MatchPredictions />
                </div>
              </div>
        ...
        {/* Featured Series */}
        <div className="py-6 px-6 bg-gradient-to-r from-[#0052CC] via-[#0066FF] to-[#003B82]">
          <div className="max-w-7xl mx-auto">
        ...
        {/* Sponsor Spotlight */}
        <div className="py-12 px-6 bg-gradient-to-r from-[#0038A8] via-[#0052CC] to-[#0066FF]">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-2xl font-bold text-white mb-8">Featured Sponsor</h2>
            <SponsorSpotlight />
          </div>
        </div>

        {/* Newsletter Signup */}
        <div className="py-12 px-6 bg-gradient-to-r from-[#0052CC] via-[#003B82] to-[#002855] border-t border-[var(--color-accent)]/30">
          <div className="max-w-7xl mx-auto">
            <NewsletterSignup />
          </div>
        </div>
        ...
        {/* Social Feeds */}
        <div className="py-12 px-6 bg-gradient-to-r from-[#0066FF] via-[#0052CC] to-[#003B82] border-t border-[var(--color-accent)]/30">
          <div className="max-w-7xl mx-auto">
            <InstagramFeed />
          </div>
        </div>
        
        <div className="py-12 px-6 bg-gradient-to-r from-[#003B82] via-[#0052CC] to-[#0066FF] border-t border-[var(--color-accent)]/30">
          <div className="max-w-7xl mx-auto">
            <FacebookFeed />
          </div>
        </div>
